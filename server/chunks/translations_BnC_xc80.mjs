...
import { i as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, r as renderComponent, A as AstroUserError } from './astro/server_BJ7CDMuq.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BAmj4wNK.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://unipay.fiandev.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BQUGUaUq.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_CV6atCwU.mjs');
...
const starlightConfig = {"social":[{"icon":"github","label":"Github","href":"https://github.com/fiandev/unipay-sdk"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Getting Started","translations":{},"collapsed":false,"items":[{"label":"Introduction","translations":{},"link":"/docs","attrs":{}},{"label":"Getting Started","translations":{},"link":"/docs/getting-started","attrs":{}}]},{"label":"API Reference","translations":{},"collapsed":false,"items":[{"label":"API Reference","translations":{},"link":"/docs/api-reference","attrs":{}}]},{"label":"Providers","translations":{},"collapsed":false,"items":[{"label":"Payment Providers","translations":{},"link":"/docs/providers","attrs":{}}]},{"label":"Guides","translations":{},"collapsed":true,"items":[{"label":"Examples","translations":{},"link":"/docs/examples","attrs":{}},{"label":"Configuration","translations":{},"link":"/docs/configuration","attrs":{}},{"label":"Error Handling","translations":{},"link":"/docs/error-handling","attrs":{}},{"label":"Migration & Upgrades","translations":{},"link":"/docs/migration","attrs":{}}]}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"UniPay SDK"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///home/runner/work/unipay-sdk/unipay-sdk/docs/","srcDir":"file:///home/runner/work/unipay-sdk/unipay-sdk/docs/src/","trailingSlash":"ignore"};
